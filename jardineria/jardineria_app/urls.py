...
from .views import (
     carro, eliminar_del_carro, procesar_pago, vaciar_carro,agregar_al_carro, flores, base, maceteros, pedido, 
    suculentas, sustratos, tierra,  home, crearcuenta, salir, producto,crearproducto,detalles_producto,modificarproducto
)

urlpatterns = [ 
    path('carro/', carro, name='carro'),
    path('carro/agregar/<int:codigo_producto>/', agregar_al_carro, name='agregar_al_carro'),
